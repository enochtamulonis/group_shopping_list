...
class ShoppingListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_list_item" do
    assert_difference('ShoppingListItem.count') do
      post shopping_list_items_url, params: { shopping_list_item: { amount: @shopping_list_item.amount, collected: @shopping_list_item.collected, name: @shopping_list_item.name, shopping_list_id: @shopping_list_item.shopping_list_id, user_id: @shopping_list_item.user_id } }
    end
  ...
  test "should update shopping_list_item" do
    patch shopping_list_item_url(@shopping_list_item), params: { shopping_list_item: { amount: @shopping_list_item.amount, collected: @shopping_list_item.collected, name: @shopping_list_item.name, shopping_list_id: @shopping_list_item.shopping_list_id, user_id: @shopping_list_item.user_id } }
